...
target_dates = unique(data_TR_ETREF$END)

target_dates <- as.POSIXct(target_dates, format = "%d/%m/%Y")
target_dates <- as.POSIXct(target_dates, tz = "UTC")
...
LA_DAILY$dates = as.POSIXct(LA_DAILY$dates, format = "%Y/%m/%d") 
LA_DAILY$dates = as.POSIXct(LA_DAILY$dates, tz = "UTC")
...
```{r calcul TR per day and TR rate  }
...
data$TR_RATE_MM_DAY = as.numeric(data$TR_RATE_MM_DAY)

data$TR_RATE_MM_DAY_CM = as.numeric(data$TR_RATE_MM_DAY_CM)
...
```{r}
ggplot(data, aes(x= data$PERIOD, y=data$TR_RATE_MM_DAY_CM)) + 
  geom_boxplot()


ggplot(data, aes(x= data$BLOCK, y=data$TR_RATE_MM_DAY_CM)) + 
  geom_boxplot() # se


ggplot(data, aes(x= data$REPETITION, y=data$TR_RATE_MM_DAY_CM)) + 
  geom_boxplot()


ggplot(data, aes(x= data$TRENCH, y=data$TR_RATE_MM_DAY_CM)) + 
  geom_boxplot()

ggplot(data, aes(x= data$PERIOD, y=data$TR_MM_DAY)) + 
  geom_boxplot()


ggplot(data, aes(x= data$BLOCK, y=data$TR_MM_DAY)) + 
  geom_boxplot() # se


ggplot(data, aes(x= data$REPETITION, y=data$TR_MM_DAY)) + 
  geom_boxplot()


ggplot(data, aes(x= data$TRENCH, y=data$TR_MM_DAY)) + 
  geom_boxplot()
```
...
data.RmOut$TR_RATE_MM_DAY_CM[data.RmOut$TR_RATE_MM_DAY_CM < 0] <- NA
...
ggplot(data.RmOut, aes(x= data.RmOut$TR_RATE_MM_DAY_CM, y=data.RmOut$TR_MM_DAY)) + 
  geom_boxplot()
```
```{r sorting outliers}
...
Xvar= "ETREF_KC" ## VPD, ETREF, or ETREF_KC
