...
ggplot(data, aes(x= data$PERIOD, y=data$TR_G_DAY)) + 
  geom_boxplot()


ggplot(data, aes(x= data$BLOCK, y=data$TR_G_DAY)) + 
  geom_boxplot() # se


ggplot(data, aes(x= data$REPETITION, y=data$TR_G_DAY)) + 
  geom_boxplot()


ggplot(data, aes(x= data$TRENCH, y=data$TR_G_DAY)) + 
  geom_boxplot()
```
...
ggplot(data.RmOut, aes(x= data.RmOut$TR_RATE, y=data.RmOut$TR_G_DAY)) + 
  geom_boxplot()
```
```{r sorting outliers}
