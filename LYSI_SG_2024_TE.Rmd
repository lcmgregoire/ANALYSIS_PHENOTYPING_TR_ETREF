...
trait_name = "TE"
trial = "LYSI_SG_2024"
model_geno_blue <- lmer(  TE ~ N_GENO 
                         + (1 | BLOCK) + (1 | REPETITION), # random factors
  data = data)
