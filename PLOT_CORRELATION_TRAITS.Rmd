...
# HTP 2023
## SLOPE TR- ETREF
SLOPE_mean_HTP_SG_2023 <- read.csv(here::here(opPATH.results, "SLOPE_mean__TR-G-H-PLANT_ETREF_HTP_SG_2023.csv"), dec = ".", sep = ";")
names(SLOPE_mean_HTP_SG_2023)[names(SLOPE_mean_HTP_SG_2023) == "SLOPE"] <- "Slope HTP" # to differentiate between the slopes of  trials
...
# ##  SLOPE TR-ETREF 
SLOPE_mean_TR_ETREF_KC_LYSI_SG_2024<- read.csv(here::here(opPATH.results, "SLOPE_mean_TR_ETREF_KC_LYSI_SG_2024.csv"), dec = ".", sep = ";")
names(SLOPE_mean_TR_ETREF_KC_LYSI_SG_2024)[names(SLOPE_mean_TR_ETREF_KC_LYSI_SG_2024) == "SLOPE"] <- "Slope Lysimeter" # to differentiate between the slopes of the two trials
# 
# ##  SLOPE TR-ETREF 
# SLOPE_mean_TRrate_ETREF_KC_LYSI_SG_2024<- read.csv(here::here(opPATH.results, "SLOPE_mean_TRrate_ETREF_KC_LYSI_SG_2024.csv"), dec = ".", sep = ";")
# names(SLOPE_mean_TRrate_ETREF_KC_LYSI_SG_2024)[names(SLOPE_mean_TRrate_ETREF_KC_LYSI_SG_2024) == "SLOPE"] <- "Slope Lysimeter" # to differentiate between the slopes of the two trials
# 
# #  SLOPE TR-ETREF 
# SLOPE_mean_TRrate_ETREF_LYSI_SG_2024<- read.csv(here::here(opPATH.results, "SLOPE_mean_TRrate_ETREF_LYSI_SG_2024.csv"), dec = ".", sep = ";")
# names(SLOPE_mean_TRrate_ETREF_LYSI_SG_2024)[names(SLOPE_mean_TRrate_ETREF_LYSI_SG_2024) == "SLOPE"] <- "Slope Lysimeter TRrate-ETREF" # to differentiate between the slopes of the two trials

# LTP 2024
##  SLOPE **TRrate**-ETREF 
SLOPE_mean_TRrate_ETREF_LTP_SG_2024 = read.csv(here::here(opPATH.results, "SLOPE_mean_TRrate_ETREF_LTP_SG_2024.csv"), dec = ".", sep = ";")
names(SLOPE_mean_TRrate_ETREF_LTP_SG_2024)[names(SLOPE_mean_TRrate_ETREF_LTP_SG_2024) == "SLOPE"] <- "Slope LTP" # to differentiate between the slopes of the two trials
...
names(ROOT_AREA_mean_LTP_SG_2024)[names(ROOT_AREA_mean_LTP_SG_2024) == "ROOT_AREA"] <- "Root area "



# nrow(SLOPE_mean_HTP_SG_2023)
# nrow(TE_mean_LYSI_SG_2024)
# nrow(SLOPE_mean_TR_ETREF_LYSI_SG_2024)
# nrow(SLOPE_mean_TRrate_ETREF_LTP_SG_2024)
# nrow(ROOT_SHOOT_mean_LTP_SG_2024)
# nrow(ROOT_AREA_mean_LTP_SG_2024)
...
# SORGHUM 
## OLD VESRION DIRECTLY FROM THE SAME FILE
# 
# ## LYSI 
...
# data_SG_list <- list(TE_mean_LYSI_SG_2024,  SLOPE_mean_TR_ETREF_KC_LYSI_SG_2024, SLOPE_mean_TRrate_ETREF_KC_LYSI_SG_2024, SLOPE_mean_TRrate_ETREF_LYSI_SG_2024,   ROOT_SHOOT_mean_LTP_SG_2024, ROOT_AREA_mean_LTP_SG_2024, SLOPE_mean_HTP_SG_2023) 
# save(data_SG_list, file =  paste0(opPATH.obj, "data_SG_list.RData"))
# 


# create a list all  dfs
data_SG_list <- list(TE_mean_LYSI_SG_2024,  SLOPE_mean_TR_ETREF_KC_LYSI_SG_2024, SLOPE_mean_TRrate_ETREF_LTP_SG_2024, ROOT_SHOOT_mean_LTP_SG_2024, ROOT_AREA_mean_LTP_SG_2024, SLOPE_mean_HTP_SG_2023) 
save(data_SG_list, file =  paste0(opPATH.obj, "data_SG_list.RData"))


# careful for a same GENO_NAME, N_GENO different from indian and senegalese trials

# Drop N_GENO safer
data_SG_list_clean <- lapply(
  data_SG_list,
  function(df) df[, !names(df) %in% "N_GENO"]
)


# Merge them all by GENO_NAME

data_SG <- Reduce(
  function(x, y) merge(x, y, by = "GENO_NAME", all = TRUE),
  data_SG_list_clean
)
...
data_SG_subset <- na.omit(data_SG[, 2:ncol(data_SG)]) ## does not accept NA 

data_SG_subset= data_SG_subset[, c(1:3, 5, 4, 6)]
...
my_colors_SG <-c("#1F77B4","#1F77B4", "#D55E00", "#D55E00","#D55E00", "#9467BD")

coef_mat <- cor_SG         # 
coef_mat[res_SG$p > 0.05] <- NA  # NA if  p > 0.05

png(filename = paste0(opPATH.fig, "correlation_SG_LTP_LYSI_HTP_TR_TRATE.png"), width = 800, height = 800)
...
## SLOPE 
# TR - ETREF * KC
SLOPE_mean_TR_ETREF_KC_LYSI_SG_2024 <- read.csv(here::here(opPATH.results, "SLOPE_mean_TR_ETREF_KC_LYSI_PM_2025.csv"), dec = ".", sep = ";")
names(SLOPE_mean_TR_ETREF_KC_LYSI_SG_2024)[names(SLOPE_mean_TR_ETREF_KC_LYSI_SG_2024) == "SLOPE"] <- "Slope Lysimeter" # to differentiate between the slopes of the two trials
# 
# # TR - ETREF * KC
# SLOPE_mean_TRrate_ETREF_KC_LYSI_PM_2025 <- read.csv(here::here(opPATH.results, "SLOPE_mean_TRrate_ETREF_KC_LYSI_PM_2025.csv"), dec = ".", sep = ";")
# names(SLOPE_mean_TRrate_ETREF_LYSI_SG_2024)[names(SLOPE_mean_TRrate_ETREF_LYSI_SG_2024) == "SLOPE"] <- "Slope Lysimeter TRrate-ETREFxKc" # to differentiate between the slopes of the two trials

# LTP 2025
## SLOPE 
SLOPE_mean_TRrate_ETREF_LTP_PM_2025 <- read.csv(here::here(opPATH.results, "SLOPE_mean_TRrate_ETREF_LTP_PM_2025.csv"), dec = ".", sep = ";")
names(SLOPE_mean_TRrate_ETREF_LTP_PM_2025)[names(SLOPE_mean_TRrate_ETREF_LTP_PM_2025) == "SLOPE"] <- "Slope LTP" # to differentiate between the slopes of the two trials
...
# create a list all  dfs
data_PM_list <- list(TE_mean_LYSI_PM_2025, SLOPE_mean_TR_ETREF_KC_LYSI_SG_2024,SLOPE_mean_TRrate_ETREF_LTP_PM_2025,ROOT_AREA_mean_LTP_PM_2025, ROOT_SHOOT_mean_LTP_PM_2025 )
...
my_colors_PM <-c("#1F77B4","#1F77B4", "#D55E00", "#D55E00","#D55E00")
