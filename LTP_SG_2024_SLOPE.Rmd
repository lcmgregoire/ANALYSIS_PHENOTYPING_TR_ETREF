...
```{r import data }
transp <- read.csv(here::here(opPATH.data, "DATA_TR_PERIOD_LTP_2024.csv"), dec = ".", sep = ";")
...
transp$TR=as.numeric(transp$TR)
transp$ETREF=as.numeric(transp$ETREF)
transp$TR_RATE=as.numeric(transp$TR_RATE)
transp$LEAF_AREA=as.numeric(transp$LEAF_AREA)
